...
import 'package:keyboard_visibility/main.dart';
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: TextButton(
                        ...
                        child: Column(
                        mainAxisAlignment: MainAxisAlignment.end, // Align the icon to the bottom
                        children: [
                        Align(
                        alignment: Alignment.bottomCenter,
                        child: Icon(
                              Icons.space_bar,
                              size: widget.keyboardHeight * .08,
                              color: widget.textColor,
                        ),
                        ),
                        ],
